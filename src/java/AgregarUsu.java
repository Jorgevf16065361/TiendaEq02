...
public class AgregarUsu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nom, apa, user, clave, privi;
            
            nom = request.getParameter("usuario_Nombre");
            apa = request.getParameter("usuario_Apellido");
            user =  request.getParameter("usuario_User");
            clave = request.getParameter("usuario_Clave");
            privi = request.getParameter("usuario_Privilegio");
            
            try{
            
                String q = "insert into usuario(usuario_Nombre, usuario_Apellido, usuario_User, usuario_Clave, usuario_Privilegio)"
                        + "values ('"+nom+"', '"+apa+"', '"+user+"', '"+clave+"', '"+privi+"')";
            ...
            out.println("<h1>Gracias por Registrarte</h1>"
                    + "<a href='login.jsp'>Ir a Sesion</a>");
