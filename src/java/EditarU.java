   ...
   private Connection con; //es el objeto para establecer la conexion de la BD
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nom, apa, user, clave, privi, id;
            
            id = request.getParameter("id_edit");            
            nom = request.getParameter("nom_edit");
            apa = request.getParameter("apa_edit");
            user =  request.getParameter("user_edit");
            clave = request.getParameter("clave_edit");
            privi = request.getParameter("privi_edit");
            try{
            
                String q = "update usuario set usuario_Nombre = '"+nom+"', usuario_Apellido = '"+apa+"', "
                        + "usuario_User = '"+user+"', usuario_Clave = '"+clave+"', usuario_Privilegio = '"+privi+"' where usuario_Codigo = '"+id+"' ";
            ...
            out.println("<body>"
                       ...
                       + "</header>");
            out.println("<h1>Se editó el usuario con Exito</h1>"
            ...
            out.println("</html>");
                ...
                System.out.println(e.getMessage());
                System.out.println(e.getStackTrace());
                out.println("<h1>No se encontro el Usuario</h1>");
